    ...
    <Layout title="Trials" active="trials" username={username}>
      ...
      <div className="panel">
        <p className="hint">
          ...
          device even if the app&apos;s local cache files are wiped. Rows with a note were blocked manually by you
          rather than earned by an actual trial grant. Remove a row to let that HWID try again.
        </p>
      </div>
